                            ...
                            \begin{subproof}[Subproof (Euclid's Lemma)]
                                ...
                                \begin{caseof}
                                    \case{($p\ | \ a$)}{
                                        ...
                                        Since $p$ is prime, the only positive divisors of $p$ are $1$ and $p$. However, $p$ does not divide $a$, so $\gcd(p, a) = 1$. Thus, $p$ and $a$ are relatively prime. Finally, since $p \mid a\cdot b$, then $p \mid b$. 
                                    }
                                \end{caseof}
                            \end{subproof}
